% the partiondata function created to split the labelled images into
...
N = round(0.80 * numFiles);                            % refered from the "TrainandDeployFullyConvolutionalNetworksExample.mat"
